...
#          FILE: 11_merryl.sh
# 
#         USAGE: ./11_merryl.sh <genome_id> <reads> <genome_size> 
...
if [ $# -lt 3  ]; then
    echo "USAGE: $0 : <genome_id> <reads> <assembler>"
    ...
    genome_id=$1       #genome/species/whatever id
...
#===============================================================================
if [ ! -s 08_meryl/results_"$genome_id".meryl/0x000000.merylData ] ;then 
	# -- build k-mer dbs --
	meryl k="$K" count $r1 output 08_meryl/results_"$genome_id".meryl
else
